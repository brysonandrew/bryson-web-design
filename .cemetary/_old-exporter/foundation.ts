...
import {
  ...
  resolveOutput,
} from '../../ops/utils/exporter/config';
import type {
  TInput,
  TInputConfig,
} from '../../ops/config/types/z-exporter';
import { initWorkspaces } from '../../ops/utils/package-json/files';
import type { TPathRecord } from '../../ops/config/types/entries';
import { INDEX_BASENAME } from '../../ops/utils/constants';
