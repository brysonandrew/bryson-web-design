...
export const resolveExtension = (entryPath: string) =>
...
export const resolveNotIndexFiles = (
  cwd: string,
  extGlob: string,
): string[] => {
...
export const resolveFull = (file: string) =>
  path.join(process.env.PROJECT_CWD || '', file);
