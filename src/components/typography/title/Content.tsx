import { ThinLine } from '@components/decoration/line';
import { ThinLineGrow } from '@components/decoration/line/ThinLineGrow';
import { MOTION_CONFIG } from '@constants/animation';
import { motion } from 'framer-motion';
import { type FC } from 'react';
import { TContent } from './config';
import { TitleRoot } from '@components/layout/space/TitleRoot';
...
export const Content: FC<TProps> = ({ children }) => {
  return (
    <TitleRoot>
      ...
      >
        <h3 className='++text text-center text-4xl md:text-4xl lg:text-5xl'>{children}</h3>
      </motion.div>
