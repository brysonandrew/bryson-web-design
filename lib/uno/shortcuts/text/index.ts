...
export const SHORTCUTS: StaticShortcutMap = {
  ...
  'title-home':
    'title-page uppercase char-gap-0_0675 text-4xl sm:text-5xl md:text-5.5xl lg:text-6xl xl:text-8xl',
  'title-section':
    'relative text-xl text-shadow-inherit char-gap-0_025 md:text-2xl',
};
